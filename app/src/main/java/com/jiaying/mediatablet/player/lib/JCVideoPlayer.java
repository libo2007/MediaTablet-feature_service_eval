...
public abstract class JCVideoPlayer extends FrameLayout implements View.OnClickListener, View.OnTouchListener, SeekBar.OnSeekBarChangeListener, SurfaceHolder.Callback, JCMediaManager.JCMediaPlayerListener {
    ...
    public JCPlayCompleteCallback completeCallback;
    public interface JCPlayCompleteCallback{
        public  void onComplete();
    }
    public void setJCPlayCompleteCallback(JCPlayCompleteCallback completeCallback){
        this.completeCallback  = completeCallback;
    }


    public JCPlayFullScreenCallback playFullScreenCallback;
    private boolean isFullScreen = false;//是否是全屏
    public void setJCPlayFullScreenCallback(JCPlayFullScreenCallback playFullScreenCallback) {
        this.playFullScreenCallback = playFullScreenCallback;
    }
    public interface JCPlayFullScreenCallback {
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.start) {
            ...
            playFullScreenCallback.isFullScreen(isFullScreen);
